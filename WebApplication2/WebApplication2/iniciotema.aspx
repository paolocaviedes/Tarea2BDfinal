<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iniciotema.aspx.cs" Inherits="WebApplication2.iniciotema" %>
...
&nbsp;&nbsp;
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ListBox ID="id_categoria2" runat="server" DataSourceID="SqlDataSource1" DataTextField="nombre" DataValueField="id_categoria" Height="121px" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" Width="168px"></asp:ListBox>
